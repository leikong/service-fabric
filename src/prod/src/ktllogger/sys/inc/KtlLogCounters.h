...
#if KTL_USER_MODE
#define KTLLOGGER_COUNTER_LOGMANAGER_NAME "Ktl Log Manager UM"
#define KTLLOGGER_COUNTER_LOGCONTAINER_NAME "Ktl Log Container UM"
#define KTLLOGGER_COUNTER_LOGSTREAM_NAME "KTL Log Stream UM"
#else
#define KTLLOGGER_COUNTER_LOGMANAGER_NAME "Ktl Log Manager"
#define KTLLOGGER_COUNTER_LOGCONTAINER_NAME "Ktl Log Container"
#define KTLLOGGER_COUNTER_LOGSTREAM_NAME "Ktl Log Stream"
#endif
